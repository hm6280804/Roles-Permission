                       ...
                       @foreach ($permissions as $permission)
                        <tr class="border-b">
                                ...
                                <td class="px-6 py-5 text-center">
                                    ...
                                    <a href="{{ route('permissions.edit', $permission->id) }}" class="bg-slate-700 text-sm rounded-md text-black px-3 py-2 hover:bg-slate-600 mr-2">
                                        Edit
                                    </a> 
                                    @endcan
                                   
                                    @can('delete permissions')
                                    <a href="javascript:void(0);" onclick="deletePermission({{ $permission->id }})" class="bg-red-700 text-sm rounded-md text-black px-3 py-2 hover:bg-red-600 ml-2">
                                        Delete 
                                    </a> 
                                    @endcan
